...
export class PurchaseService {
  ...
  deletePurchases(id: any) {
    return this.http.delete(`https://manythtry.herokuapp.com/purchases/${id}`,{responseType: 'text'});
  }

  getPurchases(): Observable<any> {
    return this.http.get("https://manythtry.herokuapp.com/purchases");

  }

  getPurchasesByUser(id: any): Observable<any> {
    return this.http.get(`https://manythtry.herokuapp.com/purchases/user/${id}`);
